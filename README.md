...
### 编辑器
- **格式化工具栏**：撤销/重做、标题、加粗/斜体/删除线、引用/代码块/列表、链接/图片/分割线/公式、专注/打字机模式
...
### 视图 & 外观
- **八套主题**：浅色（素白纸、暖阳、云白、薄荷）/ 深色（暗夜黑、深海、暖灰、墨竹），持久化 localStorage，工具栏一键切换浅/深模式
- **品牌标题栏**：左侧显示应用名称与副标语，工具栏居右排列
- **统一设置面板**：通用设置（专注/打字机/隐藏主菜单）、主题管理与预览、快捷键速查表、关于信息
- **可拖拽分栏**：双栏宽度自由调节
...
核心功能已全部实现并稳定：编辑器三模式、插件系统、安全加固、主题体系（8套）、欢迎屏/最近文件、应用图标，共 118 单元测试 + 14 E2E 测试通过，CI/CD 三平台打包就绪。
